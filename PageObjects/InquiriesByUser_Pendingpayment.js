...
exports.InquiriesByUser_Pendingpayment=class InquiriesByUser_Pendingpayment{
    ...
    constructor(page)
    {
        ...
        this.Pendingpayment= page.frameLocator('iframe[name="sideNavIFrame"]').getByRole('link', { name: 'Pending Payment' })
