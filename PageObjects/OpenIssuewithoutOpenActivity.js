exports.OpenIssuewithoutOpenActivity = class OpenIssuewithoutOpenActivity{

    constructor(page){
        this.page= page
        this.OpenIssuewithout=page.frameLocator('iframe[name="sideNavIFrame"]').getByRole('link', { name: 'Open Issue without Open' })
        this.restrictuncheck= page.getByLabel('Restricted to Alert Open')
    ...
    async clickonOpenIssuewithoutOpenActivity(){
        await this.OpenIssuewithout.click()
    }
    async clickonrestrictuncheck(){
        await this.restrictuncheck.click()
    }
