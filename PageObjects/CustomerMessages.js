exports.CustomerMessages = class CustomerMessages{

    constructor(page){

        this.page= page
        this.customerMessage=  page.frameLocator('iframe[name="sideNavIFrame"]').getByRole('link', { name: 'Customer Message' })
        ...
        this.unrestricted  = page.getByLabel('Restricted to Alert Customer')
    ...
    async uncheckrestricted(){

            await this.unrestricted.click()

    }
        

    async clikOnCustomerMessages(){
