        ...
        - list:
          ...
          - listitem:
            - link "account overview":
              - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/AccountOverview.aspx
          ...
          - listitem:
            - link "FrameMainPage ~ All":
              - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/FrameMainPage.aspx?
        ...
        - list:
          - listitem:
            ...
            - list:
              - listitem:
                - link "Statement":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/Statements.aspx
              - listitem:
                - link "Contacts":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/Contacts.aspx
              - listitem:
                - link "Invoices":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/Invoices.aspx
              - listitem:
                - link "Payments":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/Payments.aspx
              - listitem:
                - link "Contact":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/AccountInfo.aspx
                  - text: Contact Info
              - listitem:
                - link "PortalMessages":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/PortalMessages.aspx
                  - text: Messages
              - listitem:
                - link "CreditInquiry":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/CreditInquiry.aspx
                  - text: Credit Inquiry
          - listitem:
            - text: By User
            - list:
        ...
        - list:
          - listitem:
            ...
            - list:
              ...
              - listitem:
                - link "UserMaint":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/UserMaintenance.aspx
                  - text: Users
              - listitem:
          ...
          - listitem:
            ...
            - list:
              - listitem:
                - link "CountryMaint":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/CountryMaintenance.aspx
                  - text: Country
              - listitem:
                - link "ImportCustNotes":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/ImportNotes.aspx
                  - text: Import
              - listitem:
                - link "Logs":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/Logs.aspx
              - listitem:
                - link "MailRetrieval":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/Mailretrieval.aspx
                  - text: Mail Retrieval
              - listitem:
                - link "EntityMassUpdate":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/EntityMassUpdate.aspx
                  - text: Mass Update
              - listitem:
                - link "SiteOptions":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/SiteOptions.aspx
                  - text: Site Options
              - listitem:
                - link "SyncSoftware":
                  - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/SyncSchedulesMaintenance.aspx
                  - text: Sync Setup
          - listitem:
            - link "AgeCustomers":
              - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/AgeCustomers.aspx
              - text: Age Accounts 0
          - listitem:
            - link "GenerateActions":
              - /url: https://web-qa.lockstep.network//(S(fchiownxfrwm3r4a1xrwyidv))/Pages/GenerateActions.aspx
