...
```
Error: locator.click: Error: strict mode violation: locator('//*[local-name()="svg" and @data-testid="EditIcon"]') resolved to 2 elements:
    1) <svg focusable="false" aria-label="Edit" aria-hidden="true" viewBox="0 0 24 24" data-testid="EditIcon" class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv">…</svg> aka getByTestId('EditIcon').first()
    2) <svg focusable="false" aria-label="Edit" aria-hidden="true" viewBox="0 0 24 24" data-testid="EditIcon" class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv">…</svg> aka getByTestId('EditIcon').nth(1)

Call log:
  - waiting for locator('//*[local-name()="svg" and @data-testid="EditIcon"]')

    at Admin_MasterFiles_ActivityTemplate.clickOnEditIcon (/home/runner/work/azure-playwright-tests/azure-playwright-tests/azure-repo/PageObjects/Admin_MasterFiles_ActivityTemplate.js:148:29)
    at /home/runner/work/azure-playwright-tests/azure-playwright-tests/azure-repo/tests/Admin_MasterFiles_ActivityType.spec.js:105:44
```
        ...
        - list:
          ...
          - listitem:
            - link "account overview":
              - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/AccountOverview.aspx
          ...
          - listitem:
            - link "FrameMainPage ~ All":
              - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/FrameMainPage.aspx?
        ...
        - list:
          - listitem:
            ...
            - list:
              - listitem:
                - link "Statement":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/Statements.aspx
              - listitem:
                - link "Contacts":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/Contacts.aspx
              - listitem:
                - link "Invoices":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/Invoices.aspx
              - listitem:
                - link "Payments":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/Payments.aspx
              - listitem:
                - link "Contact":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/AccountInfo.aspx
                  - text: Contact Info
              - listitem:
                - link "PortalMessages":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/PortalMessages.aspx
                  - text: Messages
              - listitem:
                - link "CreditInquiry":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/CreditInquiry.aspx
                  - text: Credit Inquiry
          - listitem:
            - text: By User
            - list:
        ...
        - list:
          - listitem:
            ...
            - list:
              ...
              - listitem:
                - link "UserMaint":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/UserMaintenance.aspx
                  - text: Users
              - listitem:
          ...
          - listitem:
            ...
            - list:
              - listitem:
                - link "CountryMaint":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/CountryMaintenance.aspx
                  - text: Country
              - listitem:
                - link "ImportCustNotes":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/ImportNotes.aspx
                  - text: Import
              - listitem:
                - link "Logs":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/Logs.aspx
              - listitem:
                - link "MailRetrieval":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/Mailretrieval.aspx
                  - text: Mail Retrieval
              - listitem:
                - link "EntityMassUpdate":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/EntityMassUpdate.aspx
                  - text: Mass Update
              - listitem:
                - link "SiteOptions":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/SiteOptions.aspx
                  - text: Site Options
              - listitem:
                - link "SyncSoftware":
                  - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/SyncSchedulesMaintenance.aspx
                  - text: Sync Setup
          - listitem:
            - link "AgeCustomers":
              - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/AgeCustomers.aspx
              - text: Age Accounts 0
          - listitem:
            - link "GenerateActions":
              - /url: https://web-qa.lockstep.network//(S(wfu1bplyefxyr1bfxgkmzgsn))/Pages/GenerateActions.aspx
  ...
  - grid:
    ...
    - rowgroup:
      ...
      - row "Activity Type Issue Display Priority System Activity Exclude From Dashboard Exclude From CRM Active Proc Notes":
        - columnheader "Activity Type":
          - text: Contains
          - textbox "Contains": TestAct_ID_46
          - button "Clear filter"
        - columnheader "Issue":
          - text: Contains
          - textbox "Contains"
    ...
    - row:
      - cell
    - row "TestAct_ID_46 Test_desc_1 4 Test_note1":
      - cell "TestAct_ID_46"
      - cell "Test_desc_1"
      - cell "4"
      - cell:
      ...
      - cell:
        - checkbox [checked] [disabled]
      - cell "Test_note1"
    - row "TestAct_ID_469 Test_desc_2 5 Test_note2":
      - cell "TestAct_ID_469"
      - cell "Test_desc_2"
      - cell "5"
      - cell:
...
```ts
   48 |         this.pageSize_20= page.locator('//li[@role="option" and @data-value="20"]')
   49 |         this.total_recordsNo= page.locator('//p[@class="MuiTablePagination-displayedRows css-141284n"]')
   50 |         this.pageSize_50= page.locator('//li[@role="option" and @data-value="50"]')
   51 |         this.pageNo_1= page.locator('button[aria-label*="page 1"]')
   52 |         this.pageNo_2= page.locator('button[aria-label*="page 2"]')
   53 |         this.gotoNextPage= page.locator('//button[contains(@aria-label,"Go to next page")]')
   54 |         this.gotoPreviousPage= page.locator('//button[contains(@aria-label,"Go to previous page")]')
   55 |
   56 |         //Maintain Reports locators
   57 |         this.maintainReportbtn= page.locator('//button[contains(text(),"Maintain Reports")]')
   58 |         this.reportpage= page.locator('//div[@class="dialog-title__text m-2"]')
   59 |         this.addNewReportbtn= page.locator('//div[@aria-labelledby="draggable-dialog-title"]//button[contains(text(),"Add new record")]')
