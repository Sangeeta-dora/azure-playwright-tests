...
Call log:
  ...
  - attempting click action
    ...
    at /home/runner/work/azure-playwright-tests/azure-playwright-tests/azure-repo/tests/Admin_MasterFiles_ActivityType.spec.js:79:45
```
...
- text: Activity Base
- button "Select User to Assign"
- text: Activity ID
- textbox "Activity ID" [disabled]
- text: Description
- textbox "Description" [disabled]
- text: Display Priority
- spinbutton "Display Priority" [disabled]
