        ...
        - list:
          ...
          - listitem:
            - link "account overview":
              - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/AccountOverview.aspx
          ...
          - listitem:
            - link "FrameMainPage ~ All":
              - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/FrameMainPage.aspx?
        ...
        - list:
          - listitem:
            ...
            - list:
              - listitem:
                - link "Statement":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/Statements.aspx
              - listitem:
                - link "Contacts":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/Contacts.aspx
              - listitem:
                - link "Invoices":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/Invoices.aspx
              - listitem:
                - link "Payments":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/Payments.aspx
              - listitem:
                - link "Contact":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/AccountInfo.aspx
                  - text: Contact Info
              - listitem:
                - link "PortalMessages":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/PortalMessages.aspx
                  - text: Messages
              - listitem:
                - link "CreditInquiry":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/CreditInquiry.aspx
                  - text: Credit Inquiry
          - listitem:
            - text: By User
            - list:
        ...
        - list:
          - listitem:
            ...
            - list:
              ...
              - listitem:
                - link "UserMaint":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/UserMaintenance.aspx
                  - text: Users
              - listitem:
          ...
          - listitem:
            ...
            - list:
              - listitem:
                - link "CountryMaint":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/CountryMaintenance.aspx
                  - text: Country
              - listitem:
                - link "ImportCustNotes":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/ImportNotes.aspx
                  - text: Import
              - listitem:
                - link "Logs":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/Logs.aspx
              - listitem:
                - link "MailRetrieval":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/Mailretrieval.aspx
                  - text: Mail Retrieval
              - listitem:
                - link "EntityMassUpdate":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/EntityMassUpdate.aspx
                  - text: Mass Update
              - listitem:
                - link "SiteOptions":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/SiteOptions.aspx
                  - text: Site Options
              - listitem:
                - link "SyncSoftware":
                  - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/SyncSchedulesMaintenance.aspx
                  - text: Sync Setup
          - listitem:
            - link "AgeCustomers":
              - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/AgeCustomers.aspx
              - text: Age Accounts 0
          - listitem:
            - link "GenerateActions":
              - /url: https://web-qa.lockstep.network//(S(rrh5hhy3archejupc2baluue))/Pages/GenerateActions.aspx
  ...
  - grid:
    ...
    - rowgroup:
      ...
      - row "Activity Type Issue Display Priority System Activity Exclude From Dashboard Exclude From CRM Active Proc Notes":
        - columnheader "Activity Type":
          - text: Contains
          - textbox "Contains": TestAct_ID_44
          - button "Clear filter"
        - columnheader "Issue":
          - text: Contains
          - textbox "Contains"
    ...
    - row:
      - cell
    - row "TestAct_ID_44 Test_desc_2 5 Test_note2":
      - cell "TestAct_ID_44"
      - cell "Test_desc_2"
      - cell "5"
      - cell:
      ...
      - cell:
        - checkbox [checked] [disabled]
      - cell "Test_note2"
    - row "TestAct_ID_442 Test_desc_1 4 Test_note1":
      - cell "TestAct_ID_442"
      - cell "Test_desc_1"
      - cell "4"
      - cell:
